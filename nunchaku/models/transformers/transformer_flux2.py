...
from .utils import NunchakuModelLoaderMixin, convert_flux2_state_dict, patch_scale_key
...
class NunchakuFlux2Transformer2DModel(Flux2Transformer2DModel, NunchakuModelLoaderMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str | os.PathLike[str], **kwargs):
        ...
        model_state_dict = convert_flux2_state_dict(model_state_dict)
        ...
        # strict=False: v1 checkpoints may include zero-valued bias tensors
        # that the model doesn't expect (Flux2 diffusers linears have bias=False).
